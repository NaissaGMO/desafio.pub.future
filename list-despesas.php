...
<head>
    ...
    <div class="d-flex">
        <a href="despesas.php" class="btn">Voltar</a>
    </div>
    <div class="table">
  <table class="table">
    <thead>
        ...
        <th scope="col">Valor de despesa</th>
  ...
  <tbody>
    <?php
        while($user_data = mysqli_fetch_assoc($result))
        {
            ...
            echo "<td>".$user_data['tipo_despesa']."</td>";
            echo "<td>".$user_data['valor_despesa']."</td>";
            echo "<td>".$user_data['data_pagamento']."</td>";
            echo  "<td>
                <a class='btn-sn btn-primary' href='edit-desp.php?' id='$user_data[id]' title='Editar'>
                ...
                <a class='btn-sn btn-primary' href='delete-desp.php?' title='Excluir'>
