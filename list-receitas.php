...
<head>
    ...
    <div class="d-flex">
        <a href="receitas.php" class="btn">Voltar</a>
    </div>
    <div class="table">
  <table class="table">
    <thead>
        ...
        <th scope="col">Valor de receita</th>
  ...
  <tbody>
    <?php
        while($user_data = mysqli_fetch_assoc($result))
        {
            ...
            echo "<td>".$user_data['tipo_receita']."</td>";
            echo "<td>".$user_data['valor_receita']."</td>";
            echo "<td>".$user_data['descricao_receita']."</td>";
            echo "<td>".$user_data['data_recebimento']."</td>";
            echo  "<td>
                ...
                <a class='btn-sn btn-primary' href='delete-rec.php?' title='Excluir'>
